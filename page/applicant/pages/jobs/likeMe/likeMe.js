...
import {getBrowseMySelfApi} from '../../../../../api/pages/browse.js'
...
Page({
   ...
   */
  getLists() {
    const api = this.data.tab === 'positionList' ? 'getBrowseMySelf' : 'getCollectMySelf'
    return this[api]()
  },
  /**
   * @Author   小书包
  ...
  getBrowseMySelf(hasLoading = true) {
    return new Promise((resolve, reject) => {
      ...
      getBrowseMySelfApi(params).then(res => {
  ...
  getCollectMySelf(hasLoading = true) {
    return new Promise((resolve, reject) => {
      ...
      getCollectMySelfApi(params).then(res => {
